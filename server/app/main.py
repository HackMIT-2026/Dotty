...
from . import db
from .routers import auth, dose, food, notifications, pet, patients, simulator, sync, tasks
...
for module in (auth, sync, patients, tasks, dose, food, pet, notifications, simulator):
